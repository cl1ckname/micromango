...
type MangaResponse struct {
	...
	Rates       uint32                        `protobuf:"varint,13,opt,name=rates,proto3" json:"rates,omitempty"`
...
func (x *MangaResponse) GetRates() uint32 {
	if x != nil {
		return x.Rates
	}
	return 0
...
var file_catalog_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x65, 0x73, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x72, 0x61, 0x74, 0x65,
