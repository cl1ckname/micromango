...
type LikesNumberRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *LikesNumberRequest) Reset() {
	*x = LikesNumberRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *LikesNumberRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LikesNumberRequest) ProtoMessage() {}

func (x *LikesNumberRequest) ProtoReflect() protoreflect.Message {
	mi := &file_activity_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LikesNumberRequest.ProtoReflect.Descriptor instead.
func (*LikesNumberRequest) Descriptor() ([]byte, []int) {
	return file_activity_proto_rawDescGZIP(), []int{2}
}

func (x *LikesNumberRequest) GetMangaId() string {
	if x != nil {
		return x.MangaId
	}
	return ""
...
type LikesNumberResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *LikesNumberResponse) Reset() {
	*x = LikesNumberResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *LikesNumberResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LikesNumberResponse) ProtoMessage() {}

func (x *LikesNumberResponse) ProtoReflect() protoreflect.Message {
	mi := &file_activity_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LikesNumberResponse.ProtoReflect.Descriptor instead.
func (*LikesNumberResponse) Descriptor() ([]byte, []int) {
	return file_activity_proto_rawDescGZIP(), []int{3}
}

func (x *LikesNumberResponse) GetNumber() uint64 {
	if x != nil {
		return x.Number
	}
	return 0
...
type AvgMangaRateRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *AvgMangaRateRequest) Reset() {
	*x = AvgMangaRateRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *AvgMangaRateRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AvgMangaRateRequest) ProtoMessage() {}

func (x *AvgMangaRateRequest) ProtoReflect() protoreflect.Message {
	mi := &file_activity_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AvgMangaRateRequest.ProtoReflect.Descriptor instead.
func (*AvgMangaRateRequest) Descriptor() ([]byte, []int) {
	return file_activity_proto_rawDescGZIP(), []int{7}
}

func (x *AvgMangaRateRequest) GetMangaId() string {
	if x != nil {
		return x.MangaId
	}
	return ""
...
type AvgMangaRateResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *AvgMangaRateResponse) Reset() {
	*x = AvgMangaRateResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *AvgMangaRateResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AvgMangaRateResponse) ProtoMessage() {}

func (x *AvgMangaRateResponse) ProtoReflect() protoreflect.Message {
	mi := &file_activity_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AvgMangaRateResponse.ProtoReflect.Descriptor instead.
func (*AvgMangaRateResponse) Descriptor() ([]byte, []int) {
	return file_activity_proto_rawDescGZIP(), []int{8}
}

func (x *AvgMangaRateResponse) GetRate() float32 {
	if x != nil {
		return x.Rate
	}
	return 0
...
var file_activity_proto_rawDesc = []byte{
	...
	0x0a, 0x12, 0x4c, 0x69, 0x6b, 0x65, 0x73, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x61, 0x6e, 0x67, 0x61, 0x49, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x61, 0x6e, 0x67, 0x61, 0x49, 0x64, 0x22, 0x2d,
	0x0a, 0x13, 0x4c, 0x69, 0x6b, 0x65, 0x73, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x42, 0x0a,
	0x0e, 0x48, 0x61, 0x73, 0x4c, 0x69, 0x6b, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	...
	,
	...
	,
}
...
var file_activity_proto_goTypes = []interface{}{
	...
	(*LikesNumberRequest)(nil),   // 2: micromango.LikesNumberRequest
	(*LikesNumberResponse)(nil),  // 3: micromango.LikesNumberResponse
	(*HasLikeRequest)(nil),       // 4: micromango.HasLikeRequest
	(*HasLikeResponse)(nil),      // 5: micromango.HasLikeResponse
	(*RateMangaRequest)(nil),     // 6: micromango.RateMangaRequest
	(*AvgMangaRateRequest)(nil),  // 7: micromango.AvgMangaRateRequest
	(*AvgMangaRateResponse)(nil), // 8: micromango.AvgMangaRateResponse
	(*share.Empty)(nil),          // 9: Empty
}
var file_activity_proto_depIdxs = []int32{
	...
	2, // 2: micromango.Activity.LikesNumber:input_type -> micromango.LikesNumberRequest
	4, // 3: micromango.Activity.HasLike:input_type -> micromango.HasLikeRequest
	6, // 4: micromango.Activity.RateManga:input_type -> micromango.RateMangaRequest
	7, // 5: micromango.Activity.AvgMangaRate:input_type -> micromango.AvgMangaRateRequest
	9, // 6: micromango.Activity.Like:output_type -> Empty
	9, // 7: micromango.Activity.Dislike:output_type -> Empty
	3, // 8: micromango.Activity.LikesNumber:output_type -> micromango.LikesNumberResponse
	5, // 9: micromango.Activity.HasLike:output_type -> micromango.HasLikeResponse
	9, // 10: micromango.Activity.RateManga:output_type -> Empty
	8, // 11: micromango.Activity.AvgMangaRate:output_type -> micromango.AvgMangaRateResponse
...
func file_activity_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_activity_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LikesNumberRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_activity_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LikesNumberResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_activity_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AvgMangaRateRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_activity_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AvgMangaRateResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
