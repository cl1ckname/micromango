...
var file_profile_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x22, 0x3b, 0x0a, 0x0c,
	0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2b, 0x0a, 0x05,
	0x6d, 0x61, 0x6e, 0x67, 0x61, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x4d, 0x61,
	0x6e, 0x67, 0x61, 0x50, 0x72, 0x65, 0x76, 0x69, 0x65, 0x77, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x52, 0x05, 0x6d, 0x61, 0x6e, 0x67, 0x61, 0x22, 0x69, 0x0a, 0x10, 0x41, 0x64, 0x64,
	...
	0x5f, 0x69, 0x6e, 0x32, 0xa8, 0x02, 0x0a, 0x07, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x12,
	...
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x06, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x2f, 0x0a,
	0x08, 0x49, 0x73, 0x49, 0x6e, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x10, 0x2e, 0x49, 0x73, 0x49, 0x6e,
	0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x11, 0x2e, 0x49, 0x73,
	0x49, 0x6e, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x1d,
...
var file_profile_proto_depIdxs = []int32{
	...
	12, // 1: ListResponse.manga:type_name -> MangaPreviewResponse
	11, // 2: AddToListRequest.list:type_name -> ListName
	11, // 3: IsInListResponse.in:type_name -> ListName
	1,  // 4: Profile.Create:input_type -> CreateRequest
	3,  // 5: Profile.Update:input_type -> UpdateRequest
	4,  // 6: Profile.Get:input_type -> GetRequest
	5,  // 7: Profile.GetList:input_type -> GetListRequest
	7,  // 8: Profile.AddToList:input_type -> AddToListRequest
	8,  // 9: Profile.RemoveFromList:input_type -> RemoveFromListRequest
	9,  // 10: Profile.IsInList:input_type -> IsInListRequest
	2,  // 11: Profile.Create:output_type -> Response
	2,  // 12: Profile.Update:output_type -> Response
	2,  // 13: Profile.Get:output_type -> Response
	6,  // 14: Profile.GetList:output_type -> ListResponse
	0,  // 15: Profile.AddToList:output_type -> Empty
	0,  // 16: Profile.RemoveFromList:output_type -> Empty
	10, // 17: Profile.IsInList:output_type -> IsInListResponse
