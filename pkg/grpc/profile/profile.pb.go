...
var file_profile_proto_goTypes = []interface{}{
	...
	(*ListStatsRequests)(nil),          // 11: ListStatsRequests
	(*ListStatsResponse)(nil),          // 12: ListStatsResponse
	nil,                                // 13: ListStatsResponse.StatsEntry
	(share.ListName)(0),                // 14: ListName
	(*share.MangaPreviewResponse)(nil), // 15: MangaPreviewResponse
}
var file_profile_proto_depIdxs = []int32{
	14, // 0: GetListRequest.list:type_name -> ListName
	15, // 1: ListResponse.manga:type_name -> MangaPreviewResponse
	14, // 2: AddToListRequest.list:type_name -> ListName
	14, // 3: IsInListResponse.in:type_name -> ListName
	13, // 4: ListStatsResponse.stats:type_name -> ListStatsResponse.StatsEntry
	1,  // 5: Profile.Create:input_type -> CreateRequest
	3,  // 6: Profile.Update:input_type -> UpdateRequest
	4,  // 7: Profile.Get:input_type -> GetRequest
	5,  // 8: Profile.GetList:input_type -> GetListRequest
	7,  // 9: Profile.AddToList:input_type -> AddToListRequest
	8,  // 10: Profile.RemoveFromList:input_type -> RemoveFromListRequest
	9,  // 11: Profile.IsInList:input_type -> IsInListRequest
	11, // 12: Profile.ListStats:input_type -> ListStatsRequests
	2,  // 13: Profile.Create:output_type -> Response
	2,  // 14: Profile.Update:output_type -> Response
	2,  // 15: Profile.Get:output_type -> Response
	6,  // 16: Profile.GetList:output_type -> ListResponse
	0,  // 17: Profile.AddToList:output_type -> Empty
	0,  // 18: Profile.RemoveFromList:output_type -> Empty
	10, // 19: Profile.IsInList:output_type -> IsInListResponse
	12, // 20: Profile.ListStats:output_type -> ListStatsResponse
